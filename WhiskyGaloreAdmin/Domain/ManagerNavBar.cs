...
namespace WhiskyGaloreAdmin.Domain
{
    public class ManagerNavBar
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 5, nameOption = "Add Daily Hours", controller = "DailyHours", action = "Add", imageClass = "fa fa-table fa-fw", status = true, isParent = false, parentId = 0 });
